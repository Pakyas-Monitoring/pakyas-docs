...
- [ ] **CMD-01**: Document `auth` command with all subcommands (status, key list/set/verify/rm)
- [ ] **CMD-02**: Document `api-key` command with all subcommands (list, create, revoke)
